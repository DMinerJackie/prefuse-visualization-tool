...
public class NodeLinkTreeLayout extends TreeLayout {
     ...
     * @param group the data group to layout. Must resolve to a Graph instance.数据组的布局  必须解决的一个图形实例
     ...
     * @param dspace the spacing to maintain between depth levels of the tree  保持树之间深度的间距
     * @param bspace the spacing to maintain between sibling nodes    保持兄弟节点之间的间距
     * @param tspace the spacing to maintain between neighboring subtrees   保持相邻子树之间的间距
     */
