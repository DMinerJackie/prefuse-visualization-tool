...
// */
//public class LabelRendererImprove extends AbstractShapeRenderer {
//	
//	
...
//	 */
//	public LabelRendererImprove(String textField) {
...
//	 *            true-矩形 false-圆形
//	 */
//	public LabelRendererImprove(String textField, LabelShape shape) {
...
//	 *            will be drawn.
//	 */
//	public LabelRendererImprove(String textField, String imageField) {
...
//			rr.setArc(m_pt.getX(), m_pt.getY(), w, w, 360, 360, Arc2D.PIE);
//		} else {
//			System.out.println("-----.");
//			m_bbox.setFrame(m_pt.getX(), m_pt.getY(), w, h);// 矩形
//		} // Prefuse原来的代码
//		// if ( m_bbox instanceof Arc2D ) {
//		// Arc2D rr = (Arc2D)m_bbox;
//		// rr.setArc(m_pt.getX(), m_pt.getY(), w, w, 360, 360, Arc2D.PIE);
//		// } else {
//		// ((Arc2D) m_bbox).setArc(m_pt.getX(), m_pt.getY(), w, w, 360, 360,
//		// Arc2D.PIE);
//		// } //修改后的代码
//		return m_bbox;
//	}
...
//	/** The holder for the currently computed bounding box */
//	protected RectangularShape m_bbox = new Rectangle2D.Double(); // Prefuse框架自带的，即默认使用矩形
//	// protected RectangularShape m_bbox = new Arc2D.Double(); //让默认图形变为圆弧形
//	protected Point2D m_pt = new Point2D.Double(); // temp point
//	protected Font m_font; // temp font holder
//	protected String m_text; // label text
//	protected Dimension m_textDim = new Dimension(); // text width / height
