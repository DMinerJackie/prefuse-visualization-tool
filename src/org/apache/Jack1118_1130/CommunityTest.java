...
public class CommunityTest extends Display{
	public static final String GRAPH = "graph";
	public static final String m_lable = "label";
	...
	public CommunityTest(){
        ...
        ColorAction nStroke = new ColorAction(treeNodes, VisualItem.STROKECOLOR);
        nStroke.setDefaultColor(ColorLib.gray(100));
        nStroke.add("_hover", ColorLib.gray(50));
        
        ColorAction nFill = new ColorAction(treeNodes, VisualItem.FILLCOLOR);
        nFill.setDefaultColor(ColorLib.gray(255));
        nFill.add("_hover", ColorLib.gray(200));
        
        ColorAction nEdges = new ColorAction(treeEdges, VisualItem.STROKECOLOR);
	...
	private void InitGroups() {
        ...
        g.addEdge(6, 0);
		 VisualGraph vg = m_vis.addGraph(GRAPH, g);
	        ...
	        m_vis.setValue(treeNodes, null, VisualItem.SHAPE,
	...
	private static JFrame test() {
		CommunityTest ct = new CommunityTest();
		JFrame jf = new JFrame("CommunityTest");
