...
/**
 * 导入socialnet.xml数据集按照性别进行划分并展现,设置标签文本格式
 * @author Jack
 *
 */
public class Example1126_2 {
	...
	public static void main(String[] args) {
		...
		Font font = new Font("微软雅黑", Font.ITALIC, 14);//设置标签文本字体格式、大小
		FontAction fontAction = new FontAction("graph", font);
