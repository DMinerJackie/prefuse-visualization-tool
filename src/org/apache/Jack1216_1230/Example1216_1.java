 ...
 *
 */
public class Example1216_1 {

	private boolean m_directed = true;
	/**
	 * @param args
	 */
...
//		label.setVerticalPadding(5);
		...
		DottedEdgeRenderer edgeRenderer = new DottedEdgeRenderer(Constants.EDGE_TYPE_CURVE, Constants.EDGE_ARROW_FORWARD);
...
class DottedEdgeRenderer extends EdgeRenderer {
    public DottedEdgeRenderer(int edgeTypeCurve, int edgeArrowForward) {
        super( edgeTypeCurve, edgeArrowForward );
    }
    public void render(Graphics2D g, VisualItem item) {
        //虚线
        float[] dash1 = {5.0f};
        BasicStroke s = new BasicStroke(5.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, dash1, 0.0f);
        item.setStroke( s );
