 ...
 */
public class Example1222_1 extends Display {
    ...
    public Example1222_1(Graph g, String label) {
        ...
        ItemAction edgeColor = new ColorAction(treeEdges,VisualItem.STROKECOLOR, ColorLib.rgb(200,200,200));//新建边颜色Action
    ...
    public static JPanel demo(Graph g, final String label) {        
        ...
        final Example1222_1 gview = new Example1222_1(g, label);
