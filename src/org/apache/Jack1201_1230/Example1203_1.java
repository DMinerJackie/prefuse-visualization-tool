...
public class Example1203_1{
    ...
    public static void main(String[] argv) {
		...
		edgesStroke.add("hover()", ColorLib.gray(255));//当鼠标悬浮时设置边的颜色为白色
//		edgesStroke.add(VisualItem.FILLCOLOR, ColorLib.rgb(100, 100, 100));
		ColorAction nodeHighlight = new ColorAction("graph.nodes", VisualItem.HIGHLIGHT, ColorLib.rgb(10, 150, 220));
		
		edgeI.setFillColor(ColorLib.rgb(10, 200, 100));
		edgeI.setStrokeColor(ColorLib.rgb(100, 200, 50));
